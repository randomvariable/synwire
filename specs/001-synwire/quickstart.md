...
[dependencies]
synwire-core = "0.1"
synwire-openai = "0.1"    # Optional: for OpenAI provider
...
use synwire_openai::ChatOpenAI;

#[tokio::main]
async fn main() -> Result<(), SynwireError> {
...
use synwire_openai::{ChatOpenAI, OpenAIEmbeddings};
